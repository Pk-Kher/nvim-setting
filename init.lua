...
end, { desc = "Dev Server: Start npm run dev" })

-- move whole line upd and down with selection line
...
-- show line on center of screen
vim.opt.colorcolumn = "80"
-- show diagnostic under cursor //errors and warnings
...
require("lazy").setup({
  ...
  {
    --enable sticky scoll where function defination always show on top when i'm inside the function
...

  {
    ...
    config = function()
      ...
      end, { desc = "Harpoon: Add first file" })

      vim.keymap.set("n", "<leader>a", function()
        harpoon:list():add()
      end, { desc = "Harpoon: Add last file" })
